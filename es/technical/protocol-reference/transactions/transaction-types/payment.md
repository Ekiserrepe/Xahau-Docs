...
| `DestinationTag` | Number                                                                                                                             | UInt32              | _(Opcional)_ Etiqueta arbitraria que identifica el motivo del pago al destino o un destinatario hospedado para pagar.                                                                                                                                                                                                                                                                                                                          |
...
Para más información, consulta Cuentas.
...
Por sí solo, el flag `tfLimitQuality` reduce las situaciones en las que una transacción puede tener éxito. Específicamente, rechaza pagos donde alguna parte del pago utiliza una conversión desfavorable, incluso si la calidad promedio general de las conversiones en el pago es igual o mejor que el límite de calidad. Si un pago es rechazado de esta manera, el resultado de la transacción es `tecPATH_DRY`.
